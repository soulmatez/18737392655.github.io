...
class Widget_Options_General extends Widget_Abstract_Options implements Widget_Interface_Do
{
    ...
    public function form()
    {
		...
		/** 站点logo */
		$logoUrl = new Typecho_Widget_Helper_Form_Element_Text('logoUrl', NULL, $this->options->logoUrl, _t('站点logo'), _t('留空则直接显示站点文字标题.'));
		$logoUrl->input->setAttribute('class', 'w-100');
    ...
    public function updateGeneralSettings()
    {
        ...
        $settings = $this->request->from('logoUrl','title','description', 'keywords', 'allowRegister', 'allowXmlRpc', 'lang', 'timezone');
